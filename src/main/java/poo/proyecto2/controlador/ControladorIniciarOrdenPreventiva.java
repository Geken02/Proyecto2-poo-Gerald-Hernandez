...
import poo.proyecto2.vista.gui.vistas.VentanaIniciarOrdenPreventiva; // Referencia a la vista
...
public class ControladorIniciarOrdenPreventiva {

    private SistemaPrincipal modelo;
    private VentanaIniciarOrdenPreventiva vista; // Referencia a la vista
    private OrdenTrabajoPreventiva ordenActual; // Referencia a la orden que se está gestionando

    public ControladorIniciarOrdenPreventiva(SistemaPrincipal modelo, VentanaIniciarOrdenPreventiva vista) {
        this.modelo = modelo;
        this.vista = vista;
    ...
    public void iniciarOrden() {
        ...
        boolean iniciada = modelo.iniciarOrdenPreventiva(ordenActual.getId(), fechaInicio);
